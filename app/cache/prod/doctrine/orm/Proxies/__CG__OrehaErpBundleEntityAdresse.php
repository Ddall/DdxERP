 ...
 */
class Adresse extends \Oreha\ErpBundle\Entity\Adresse implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'voie', 'complement', 'codePostal', 'ville', 'latitude', 'longitude');
        }
    ...
    public function getFullAdresse()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFullAdresse', array());
